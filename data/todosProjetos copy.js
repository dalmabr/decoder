function todosProjetos() {
    ...
    table.innerHTML = `
        ...
        <thead>
            <tr>
                <th data-sort="nomeColuna" style="cursor: pointer;">ID</th>
                <th data-sort="programa" style="cursor: pointer;">Tipo</th>
                <th data-sort="tabela" style="cursor: pointer;">Data Inicio</th>
                <th data-sort="operacao" style="cursor: pointer;">Data Modificação</th>
                <th data-sort="origem" style="cursor: pointer;">Resumo</th>
            </tr>
        </thead>
        <tbody></tbody>
    `;
